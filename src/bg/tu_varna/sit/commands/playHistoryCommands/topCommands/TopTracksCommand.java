...
/**
 * Клас за команда извеждаща топ {@code N} на брой песни в определен период
 */
public class TopTracksCommand extends Command {
    ...
    /**
     * Конструктор на команда извеждаща топ {@code N} на брой песни в определен период
    ...
    /**
     * Изълняващ метод на команда за извеждане на топ {@code N} на брой песни в определен период
     * @param args аргументи които командата приема
     * @return топ {@code N} на брой песни в определен период
     */
    @Override
    protected String execute(List<String> args) {
        ...
        topTracks.forEach((song, count) ->
            sb.append(song).append(" - Number of plays: ").append(count).append("\n")
        );
        return sb.toString();
    }
